package es.pedrazamiguez.onlinebookstore.application.adapter;

import es.pedrazamiguez.onlinebookstore.domain.adapter.CalculateSubtotalAdapter;
import es.pedrazamiguez.onlinebookstore.domain.model.BookType;
